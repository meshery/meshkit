...
// retry abstraction for use across Meshery and its satellite components.
//
// # Overview
//
...
//   - Context cancelled / deadline exceeded → return ctx.Err() (the loop
//     exits automatically; do not wrap in Permanent)
package retry
